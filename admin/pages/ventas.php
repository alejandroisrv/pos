            ...
            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
              <div class="breadcomb-wp">
                ...
                <div class="breadcomb-ctn">
                  <h2>Ventas</h2>
                  <p>Las ventas procesadas en el local, aparecerán aquí. Puedes acceder a los detalles, incluso descargarlos.</p>
                </div>
              </div>
            </div>
...
<!-- Breadcomb area End-->
  ...
  <div class="data-table-area">
    ...
    request("pages/ventas-tabla.php",null,$('#tabla-ventas'));
    ...
    $(document).ready(function () {
        ...
        var data = {
          ...
          console.log(data);
          request("pages/ventas-tabla.php",data,$('#tabla-ventas'));
        })
    });
