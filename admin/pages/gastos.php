            ...
            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
              <div class="breadcomb-wp">
                ...
                <div class="breadcomb-ctn">
                  <h2>Gastos</h2>
                  <p>Todos los gastos, aparecerán aquí. Puedes acceder a los detalles, incluso descargarlos.</p>
                </div>
              </div>
            </div>
...
<!-- Breadcomb area End-->
  ...
  <div class="data-table-area">
      <div class="container">
          ...
          <div class="row" id="tabla-gastos">

            </div>
        </div>
    </div>
    <script type="text/javascript">
    request("pages/gastos-tabla.php",null,$('#tabla-gastos'));
      //03/24/2019
    ...
    $(document).ready(function () {
        ...
        var data = {
          ...
          console.log(data);
          request("pages/gastos-tabla.php",data,$('#tabla-gastos'));
